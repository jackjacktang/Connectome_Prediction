...
if __name__ == '__main__':
    ...
    opt.checkpoints_dir = '../checkpoints/epi_predict_patient_five_fold'
    ...
    # for fold in range(1, 2):
        ...
        opt.name = 'epi_predict_patient_fold' + str(fold)
    ...
    ana_path = '/home/jack/MRgFUS/Epilipsy_Data/ana_patient/'
